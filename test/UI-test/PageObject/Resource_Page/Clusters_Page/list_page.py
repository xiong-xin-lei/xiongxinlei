...
class list_Page(SeleniumBase):
    ...
    title = '集群'
    loc_list = (By.XPATH, '//*[@id="pane-/dbscale/app/resource/clusters?id=102000000&menu=%7B%22name%22%3A%22%E8%B5%84%E6%BA%90%E7%AE%A1%E7%90%86%22%2C%22icon%22%3A%22resource.svg%22%2C%22subMenu%22%3A%7B%22name%22%3A%22%E9%9B%86%E7%BE%A4%E7%AE%A1%E7%90%86%22%7D%7D"]/iframe')
    ...
    def click_row_enabled_button(self, key):
        ...
        row_enabled = (By.XPATH, f'/html/body/div[1]/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[{order}]/td[11]/div/span[1]/button')
    ...
    def click_row_disabled_button(self,key):
        self.logger.info('元素定位')
        order = self.get_row_order(self.table_loc, key)
        row_disabled = (By.XPATH, f'/html/body/div[1]/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[{order}]/td[11]/div/span[2]/button')
        self.logger.info("点击行内停用按钮")
    ...
    def button_move_over(self,key):
        self.logger.info('元素定位')
        order = self.get_row_order(self.table_loc, key)
        row_more = (By.XPATH, f'/html/body/div[1]/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[{order}]/td[11]/div/div/span')
