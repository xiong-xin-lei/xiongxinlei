...
class btnIn_Page(SeleniumBase):

    loc_btnIn_page = (By.XPATH, '/html/body/div[5]/div[2]/iframe')
    ...
    loc_btnIn_checkout = (By.XPATH, '/html/body/div/div[3]/button[1]')
    loc_btnIn = (By.XPATH, '/html/body/div[1]/div[3]/button[2]')
    ...
    def btnIn_in(self):
        ...
        self.select_frame(self.loc_btnIn_page)
    ...
    def click_btnIn_checked_button(self):
        self.logger.info("点击入库校验按钮")
        self.click_element(self.loc_btnIn_checkout)

    def click_btnIn_button(self):
        self.logger.info("点击入库按钮")
        assert self.is_button_disabled(self.loc_btnIn) != 'true', '按钮处于禁用状态，不可点击'
        self.click_element(self.loc_btnIn)
    ...
    def btnIn(self, port, userName, password):
        self.send_port(port)
        self.send_userName(userName)
        self.send_password(password)
        self.click_btnIn_checked_button()
