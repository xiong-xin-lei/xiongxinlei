...
class before_edit_Page(SeleniumBase):
    ...
    loc_hotSpare = (By.XPATH, '/html/body/div[1]/div[1]/form/div[6]/div/div/div/span')
    ...
    def edit(self, business_area, clusters, hostIp, room, seat, hddPaths, ssdPaths, remoteStorageId, maxUnitCnt,
