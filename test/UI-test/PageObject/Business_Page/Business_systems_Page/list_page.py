...
class list_Page(SeleniumBase):
    ...
    def is_disabled_disable(self, key):
        order = self.get_row_order(self.table_loc, key)
        row_disabled = (
            By.XPATH, f'/html/body/div[1]/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[{order}]/td[6]/div/span[3]/button')
    ...
    def click_row_subsystems_button(self, key):
        self.logger.info('元素定位')
        order = self.get_row_order(self.table_loc, key)
        row_subsystems = (
            By.XPATH,
            f'/html/body/div[1]/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[{order}]/td[6]/div/span[1]/button')
        self.logger.info("点击行内子系统按钮")
        self.click_element(row_subsystems)
