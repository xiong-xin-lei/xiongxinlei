...
<div id="list" v-cloak>
    ...
    <div class="iframeBorder">
        ...
        <vxe-table size="small" highlight-hover-row resizable auto-resize border="inner" :max-height="table_heighth" style="color: #333333;"
            ...
            <vxe-table-column sortable field="name" v-bind="commonMinWidth('组名')" show-header-overflow show-overflow></vxe-table-column>
...
<script type="text/javascript" src="js/system/groups/list.js?t=<%=new Date().getTime() %>"></script>
