...
<div id="edit" v-cloak>
    <div style="padding:30px 40px 30px 20px">
        <el-form ref="editForm" :model="formData" :rules="formRules" label-width="70px" size="small">
            <el-form-item label="组名" prop="name">
                <el-input v-model="formData.name" placeholder="请输入组名"></el-input>
            </el-form-item>
...
<script type="text/javascript" src="js/system/groups/edit.js?t=<%=new Date().getTime() %>"></script>
