...
<div id="edit" v-cloak>
    <div style="padding:30px 40px 30px 20px">
        <el-form ref="editForm" :model="formData" :rules="formRules" label-width="115px" size="small">
...
<script type="text/javascript" src="js/system/roles/edit.js?t=<%=new Date().getTime() %>"></script>
