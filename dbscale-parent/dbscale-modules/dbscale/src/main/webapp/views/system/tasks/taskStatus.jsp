        ...
        <div class="btnParentDiv" style="font-size:12px">
            <div id="btnPanel">
                ...
                <div style="padding-left:10px;display: inline-block;">
                    <el-button size="small" @click="SearchTasks()" icon="el-icon-search">搜索</el-button>
                </div>
                <div style="padding-left:10px;display: inline-block;">
        ...
        <vxe-table size="small" highlight-hover-row resizable auto-resize border="inner" :max-height="table_heighth" style="color: #333333;"
            ...
            <vxe-table-column sortable type="expand" width="0" :resizable="false"> 
                <template v-slot:content="{ row }">
                    <vxe-table size="small" :ref="'childTable'+row.id" style="color: #333333;margin: 10px 40px;border-left: 1px #E8EAEC solid"
            ...
            <vxe-table-column sortable field="objType.display" v-bind="commonMinWidth('对象类型')" max-width="" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="action.display" v-bind="commonMinWidth('任务类型')" show-header-overflow show-overflow></vxe-table-column>
            ...
            <vxe-table-column sortable field="consumeTime" v-bind="commonMinWidth('耗时（s）')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="statusText" v-bind="commonMinWidth('任务状态')" show-header-overflow show-overflow>
                <template v-slot="{ row }">
...
<script type="text/javascript" src="js/system/tasks/taskStatus.js?t=<%=new Date().getTime() %>"></script>
