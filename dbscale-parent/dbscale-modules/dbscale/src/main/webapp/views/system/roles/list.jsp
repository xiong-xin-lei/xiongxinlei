...
<div id="list" v-cloak>
    ...
    <div class="iframeBorder">
        ...
        <vxe-table size="small" highlight-hover-row resizable auto-resize border="inner" :max-height="table_heighth" style="color: #333333;"
            ...
            <vxe-table-column sortable field="name" v-bind="commonMinWidth('角色名称')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="dataScope.display" v-bind="commonMinWidth('可见数据范围')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="managerText" v-bind="commonMinWidth('管理角色')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="sys" v-bind="commonMinWidth('系统资源')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="createdName" v-bind="commonMinWidth('创建者')" show-header-overflow show-overflow></vxe-table-column>
...
<script type="text/javascript" src="js/system/roles/list.js?t=<%=new Date().getTime() %>"></script>
