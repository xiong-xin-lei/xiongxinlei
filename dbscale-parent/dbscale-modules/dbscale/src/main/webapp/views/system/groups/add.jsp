...
<div id="add" v-cloak>
    <div style="padding:30px 40px 30px 20px">
        <el-form ref="addForm" :model="formData" label-width="70px" :rules="formRules" size="small">
...
<script type="text/javascript" src="js/system/groups/add.js?t=<%=new Date().getTime() %>"></script>
