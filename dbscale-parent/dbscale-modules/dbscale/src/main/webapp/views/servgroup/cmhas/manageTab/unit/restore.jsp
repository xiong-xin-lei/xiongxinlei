...
<div id="cmhaRestore" v-cloak>
    <div style="background-color: #ffffff;">
        ...
        <vxe-table size="small" highlight-hover-row resizable auto-resize border="inner" style="color: #333333;"
                   ...
                   ref="cmhaRestore" @sort-change="sortChange" :data="tableData"
...
<script type="text/javascript" src="js/servgroup/cmhas/manageTab/unit/restore.js?t=<%=new Date().getTime() %>"></script>
