...
<div id="resetPwd" v-cloak>
    <div style="padding:30px 40px 30px 20px">
        <el-form ref="resetPwdForm" :model="formData" label-width="100px" :rules="formRules" size="small">
    ...
    <div style="float: right;padding: 10px 20px">
        <el-button size="small" type="primary" @click="formSubmit('resetPwdForm')">保存</el-button>
        <el-button size="small" @click="formClose">取消</el-button>
    </div>
</div>
</body>

<script type="text/javascript" src="js/servgroup/mysqls/manageTab/user/resetPwd.js?t=<%=new Date().getTime() %>"></script>
