...
<div id="topologyList">
    ...
    <div id="cmhaTopology" style="height: 550px; width: 1370px; margin: 0 auto;"></div>
</div>
</body>
...
<script type="module" src="js/servgroup/mysqls/manageTab/topology/list.js?t=<%=new Date().getTime() %>"></script>
