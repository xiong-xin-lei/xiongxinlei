...
<body>
<div id="backupStrategyEdit" v-cloak>
	<div style="padding:30px 40px 30px 20px">
		<el-form ref="backupStrategyForm" :model="formData" label-width="110px" size="small">
			...
			<el-form-item label="备份类型" prop="type">
				<el-select v-model="formData.type" placeholder="请选择备份存储类型" style="display: block;">
			...
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="时间" prop="time" label-width="70px">
						<el-time-picker v-model="formData.time" format="HH:mm" value-format="mm HH" :clearable="false" placeholder="请选择时间" style="width: auto;"></el-time-picker>
					</el-form-item>
				</el-col>
			</el-row>
...
<script type="text/javascript"
		src="js/servgroup/mysqls/manageTab/backupStrategy/edit.js?t=<%=new Date().getTime() %>"></script>
