...
<div id="manage" v-cloak>
    ...
    <el-tabs v-model="activeName" type="border-card">
        ...
        <iframe width="100%" style="height: calc(100vh - 134px);" :src="tabUrl()"></iframe>
    </el-tabs>
...
<script type="text/javascript" src="js/servgroup/redis/manage.js?t=<%=new Date().getTime() %>"></script>
