            ...
            <div style="padding:20px 10px;height: 30px;">
                <el-form ref="rebuildForm" :inline="true" :model="formData" label-width="70px" size="small">
                    <el-form-item label="重建策略">
                        <el-select v-model="formData.strategy" placeholder="请选择重建策略"
                                   @change="hostChange">
...
<script type="text/javascript" src="js/servgroup/redis/manageTab/unit/rebuild.js?t=<%=new Date().getTime() %>"></script>
