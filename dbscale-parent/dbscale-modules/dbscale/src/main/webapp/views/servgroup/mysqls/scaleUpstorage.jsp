	  ...
	  <div style="padding:30px 40px 30px 20px">
		  <el-form ref="scaleUpForm" :model="formData" label-width="100px" :rules="formRules" size="small">
			  ...
			  <el-form-item :label="dataShow()" prop="dataSize">
				  <el-input v-model="formData.dataSize" maxlength="6" oninput="value=value.replace(/[^\d]/g,'')">
					  <template slot="append">G</template>
				  </el-input>
			  </el-form-item>
			  <el-form-item :label="logShow()" prop="logSize">
				  <el-input v-model="formData.logSize" maxlength="6" oninput="value=value.replace(/[^\d]/g,'')">
					  <template slot="append">G</template>
				  </el-input>
			  </el-form-item>
...
<script type="text/javascript" src="js/servgroup/mysqls/scaleUpstorage.js?t=<%=new Date().getTime() %>"></script>