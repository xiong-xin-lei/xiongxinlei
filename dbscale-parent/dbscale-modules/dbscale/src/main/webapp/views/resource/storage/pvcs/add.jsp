	  ...
	  <div style="padding:30px 40px 30px 20px">
		<el-form ref="addForm" :model="formData" label-width="100px" :rules="formRules" size="small">
			<el-form-item label="存储名称" prop="name">
		    	<el-input v-model="formData.name" placeholder="请输入存储名称"></el-input>
			</el-form-item>
			<el-form-item label="供应商" prop="provisioner">
		    	<el-input v-model="formData.provisioner" placeholder="请输入供应商"></el-input>
			</el-form-item>
...
<script type="text/javascript" src="js/resource/storage/pvcs/add.js?t=<%=new Date().getTime() %>"></script>
</html>