...
<div id="edit" v-cloak>
	 <div style="padding:30px 40px 30px 20px">
		<el-form ref="editForm" :model="formData" :rules="formRules" label-width="110px" size="small">
			<el-form-item label="外置存储名称" prop="name">
...
<script type="text/javascript" src="js/resource/storage/volumepaths/edit.js?t=<%=new Date().getTime() %>"></script>
</html>