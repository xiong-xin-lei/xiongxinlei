...
<div id="list" v-cloak>
    ...
    <div class="iframeBorder">
        ...
        <vxe-table size="small" :max-height="table_heighth" highlight-hover-row resizable auto-resize border="inner" style="color: #333333;"
            ...
            <vxe-table-column sortable field="name" v-bind="commonMinWidth('外置存储名称')" show-header-overflow show-overflow width="12%"></vxe-table-column>
            <vxe-table-column sortable field="vendorVersion" v-bind="commonMinWidth('型号')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="ip" v-bind="commonMinWidth('IP')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="port" v-bind="commonMinWidth('端口')" show-header-overflow show-overflow></vxe-table-column>
            ...
            <vxe-table-column sortable field="state" v-bind="commonMinWidth('运行状态')" type="html" show-header-overflow show-overflow width="8%">
				<template v-slot="{ row }">
					<div v-html="statusShow(row,'state')"></div>
				</template>
            </vxe-table-column>
...
<script type="text/javascript" src="js/resource/storage/volumepaths/list.js?t=<%=new Date().getTime() %>"></script>
