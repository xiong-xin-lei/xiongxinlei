...
<body>
<div id="editIdentification" v-cloak>
	<div style="margin: 20px auto 0; width: 350px;">
		<el-form ref="editIdentificationForm" :model="formData" label-width="65px" :rules="formRules" size="small">
	...
	<div style="float: right;padding: 10px 20px">
		<el-button size="small" type="primary" @click="formSubmit('editIdentificationForm')">校验</el-button>
		<el-button size="small" @click="formClose">取消</el-button>
	</div>
</div>
</body>

<script type="text/javascript" src="js/resource/hosts/edit/identification.js?t=<%=new Date().getTime() %>"></script>
</html>