...
<div id="list" v-cloak>
    ...
    <div class="iframeBorder">
        ...
        <vxe-table size="small" :max-height="table_heighth" highlight-hover-row resizable auto-resize border="inner" style="color: #333333;"
            ...
            <vxe-table-column sortable field="provisioner" v-bind="commonMinWidth('供应商')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="reclaimPolicy.display" v-bind="commonMinWidth('卷回收策略')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="volumeBingdingType.display" v-bind="commonMinWidth('卷绑定模式')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="allowVolumeExpansion" v-bind="commonMinWidth('允许卷扩展')" show-header-overflow show-overflow></vxe-table-column>
...
<script type="text/javascript" src="js/resource/storage/pvcs/list.js?t=<%=new Date().getTime() %>"></script>
