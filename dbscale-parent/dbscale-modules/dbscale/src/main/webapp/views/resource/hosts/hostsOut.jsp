...
<div id="out" v-cloak>
	<div style="margin: 20px auto 0; width: 350px;">
		<el-form ref="outForm" :model="formData" label-width="65px" :rules="formRules" size="small">
	...
	<div style="float: right;padding: 10px 20px">
		<el-button size="small" @click="identification">出库校验</el-button>
		<el-button size="small" type="primary" @click="formSubmit('outForm')" :disabled="hostOut">出库</el-button>
...
<script type="text/javascript" src="js/resource/hosts/hostsOut.js?t=<%=new Date().getTime() %>"></script>
</html>