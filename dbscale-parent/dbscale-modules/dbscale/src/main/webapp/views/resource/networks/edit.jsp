                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="起始IP" prop="startIp">
                            <el-input v-model="formData.startIp" maxlength="15" disabled></el-input>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="结束IP" prop="endIp">
                            <el-input v-model="formData.endIp" maxlength="15" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="网关" prop="gateway">
                            <el-input v-model="formData.gateway" maxlength="15" disabled></el-input>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="掩码" prop="netmask">
                            <el-input v-model="formData.netmask" maxlength="2" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="VLAN" prop="vlan">
                            <el-input v-model="formData.vlan" maxlength="8" disabled></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="网络拓扑" prop="topologys">
                            <el-select v-model="formData.topologys" placeholder="请选择网络拓扑（可多选）" style="display: block;"
                                multiple>
...
<script type="text/javascript">
    <% Object networksId = request.getAttribute("networksId"); %>
    var networksId = <%= networksId %>
</script>

<script type="text/javascript" src="js/resource/networks/edit.js?t=<%=new Date().getTime() %>"></script>