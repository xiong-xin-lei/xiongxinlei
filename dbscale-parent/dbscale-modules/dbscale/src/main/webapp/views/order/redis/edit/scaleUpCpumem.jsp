				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="规模" prop="scale">
							<el-select v-model="formData.scale" placeholder="请选择规模" style="display: block;" ref="scaleRadios" @change="scaleChange">
								<el-option :label="data.name" :value="data.name" v-for="data in scaleList" :data-cpuCnt="data.cpuCnt" :data-memSize="data.memSize"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
				</el-row>
...
<script type="text/javascript" src="js/order/redis/edit/scaleUpCpumem.js?t=<%=new Date().getTime() %>"></script>
</html>