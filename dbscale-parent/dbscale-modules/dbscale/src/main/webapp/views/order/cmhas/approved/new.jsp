    ...
    <div id="approvedNew" v-cloak>
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="备份周期" prop="cronExpression">
                                <el-select disabled v-model="formData.cronExpression" clearable placeholder=" "
                                    style="display: block;">
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item :label="fileRetentionName()" prop="fileRetentionNum">
                                <el-input disabled v-model="formData.fileRetentionNum" controls-position="right"
                                    style="display: block;width:auto;"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
        ...
        <div style="position: absolute;right: 0px;bottom: 0px;width:778px">
            ...
            <div style="float: right;padding: 10px 20px">
                ...
                <el-button size="small" type="danger" @click="formSubmit('approvedNew', false)"
                    v-show="stepsActive ===XEUtils.max([1, stepPageNum, stepPageNums])">拒绝</el-button>
                <el-button size="small" type="primary" @click="formSubmit('approvedNew', true)"
                    v-show="stepsActive ===XEUtils.max([1, stepPageNum, stepPageNums])">同意</el-button>
...
<script type="text/javascript" src="js/order/cmhas/approved/new.js?t=<%=new Date().getTime() %>"></script>
