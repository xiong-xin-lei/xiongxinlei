...
<body>
    <div id="executeImageUpdate" v-cloak>
        ...
        <div class="setupDIV">
            <el-form ref="executeImageUpdate" :model="formData" label-width="115px" size="small">
		...
		<div style="float: right;padding: 10px 20px">
			...
			<el-button size="small" type="primary" @click="formSubmit('executeImageUpdate')"  v-show="stepsActive === 1">执行</el-button>
...
<script type="text/javascript" src="js/order/cmhas/execute/imageUpdate.js?t=<%=new Date().getTime() %>"></script>
</html>