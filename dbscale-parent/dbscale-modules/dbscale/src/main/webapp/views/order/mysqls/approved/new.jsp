...
<div id="approvedNew" v-cloak>
    ...
    <div class="setupDIV">
        <el-form ref="approvedNew" :model="formData" label-width="115px" size="small">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="端口" prop="mysqlport">
                            <el-input disabled v-model="formData.mysqlport"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="硬件架构" prop="sysArchitecture">
                            <el-input disabled v-model="formData.sysArchitecture"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="版本" prop="mysqlversion">
                            <el-input disabled v-model="formData.mysqlversion"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="架构" prop="arch">
                            <el-input disabled v-model="formData.mysqlarch"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="副本数量" prop="unitCnt" v-if="formData.mysqlarch!=='单节点'">
                            <el-input disabled v-model="formData.mysqlunitCnt"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="规模" prop="mysqlscale">
                            <el-input disabled v-model="formData.mysqlscale"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" v-if="getSession('storageMode') == 'volumepath'">
                        <el-form-item label="磁盘类型" prop="mysqldiskType">
                            <el-input disabled v-model="formData.mysqldiskType"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="表空间(G)" prop="mysqldataSize">
                            <el-slider v-model="formData.mysqldataSize" show-input :min=10 :max=500 :step=1 disabled
                ...
                <%--<el-row>
                    <el-col :span="24">
                        <el-form-item label="日志空间(G)" prop="mysqllogSize">
                            <el-slider v-model="formData.mysqllogSize" show-input :min=10 :max=500 :step=1 disabled :format-tooltip="formatToolTip"></el-slider>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row style="height: 51px">
                    <el-col :span="8">
                        <el-form-item label="高可用">
                            <el-switch v-model="formData.highAvailable" disabled></el-switch>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8" v-if="formData.highAvailable">
                        <el-form-item label="代理数量">
                            <el-input-number v-model="formData.proxyNum" :step="1" disabled></el-input-number>
                        </el-form-item>
                    </el-col>
                </el-row>--%>
                <el-row>
                    ...
                    <el-col :span="4" v-if="advanced">
                        <el-checkbox v-model="paramDeploy" style="padding-top:5px" disabled>参数配置</el-checkbox>
                    </el-col>
                    <el-col :span="4" v-if="advanced">
                        <el-checkbox v-model="backupPolicy" style="padding-top:5px" disabled>备份策略</el-checkbox>
                    </el-col>
                </el-row>
            </div>
            <div v-else-if="stepsActive === stepPageNums" class="elSteps">
                <el-form-item label="参数配置" prop="hotSpare">
                    <vxe-table size="small" style="color: #333333;margin: 10px 40px;border-left: 1px #E8EAEC solid"
                               show-overflow :data="formData.mysqlparamCfg" show-header-overflow auto-resize border
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="备份周期" prop="cronExpression">
                            <el-select disabled v-model="formData.cronExpression" clearable placeholder=" " style="display: block;">
                    ...
                    <el-col :span="8">
                        <el-form-item label="时间" prop="time" label-width="70px">
                            <el-time-picker disabled v-model="formData.time" format="HH:mm" value-format="mm HH" style="width: auto;"></el-time-picker>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="8">
                        <el-form-item :label="fileRetentionName()" prop="fileRetentionNum">
                            <el-input disabled v-model="formData.fileRetentionNum" controls-position="right" style="display: block;width:auto;"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
            ...
            <div v-else-if="approvedInfoShow()">
    ...
    <div style="position: absolute;right: 0px;bottom: 0px;width:778px">
        ...
        <div style="float: right;padding: 10px 20px">
            ...
            <el-button size="small" @click="stepsActive++" v-show="stepsActive !==XEUtils.max([1, stepPageNum, stepPageNums])">下一步</el-button>
            <el-button size="small" type="danger" @click="formSubmit('approvedNew', false)" v-show="stepsActive ===XEUtils.max([1, stepPageNum, stepPageNums])">拒绝</el-button>
            <el-button size="small" type="primary" @click="formSubmit('approvedNew', true)" v-show="stepsActive ===XEUtils.max([1, stepPageNum, stepPageNums])">同意</el-button>
...
<script type="text/javascript" src="js/order/mysqls/approved/new.js?t=<%=new Date().getTime() %>"></script>
