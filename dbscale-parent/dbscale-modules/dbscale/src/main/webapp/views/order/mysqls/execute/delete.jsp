	...
	<div class="setupDIV">
        	 ...
        	 <el-row>
                <el-col :span="24">
                    <el-form-item label="审批信息" prop="description">
                        <el-input type="textarea" rows="7" v-model="formData.msg"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
        	</div> -->
	 ...
	 <div style="position: absolute;right: 0px;bottom: 0px;width:778px">
		...
		<div style="float: right;padding: 10px 20px">
			...
			<el-button size="small" type="primary" @click="formSubmit('executeImageUpdate', true)" v-show="stepsActive ===0">执行</el-button>
...
<script type="text/javascript" src="js/order/mysqls/execute/delete.js?t=<%=new Date().getTime() %>"></script>
</html>