...
<body>
<div id="approvedScaleUp" v-cloak>
	<div class="orderTitle" v-if="ogAutoExecute">该申请单将自动执行</div>
	 <el-steps :active="stepsActive" finish-status="success" align-center style="padding-top:10px">
        ...
        <div class="setupDIV">
		<el-form ref="approvedScaleUp" :model="formData" label-width="115px" size="small">
			...
			<div v-else-if="stepsActive === 1">
				...
				<el-row>
					<el-col :span="24">
						<el-form-item :label="dataShow()" prop="dataSize"status-icon>
				...
				<el-row>
					<el-col :span="24">
						<el-form-item :label="logShow()" prop="logSize">
				...
				<!-- <el-row>
					<el-col :span="24">
						<el-form-item label="审批信息" prop="description">
							<el-input type="textarea" rows="4" v-model="formData.msg" maxlength="128"></el-input>
						</el-form-item>
					</el-col>
				</el-row> -->
			</div>
	...
	<div style="position: absolute;right: 0px;bottom: 0px;width:778px">
			...
			<div style="float: right;padding: 10px 20px">
				...
				<el-button size="small" type="danger" @click="formSubmit('approvedScaleUp', false)" v-show="stepsActive ===1">拒绝</el-button>
				<el-button size="small" type="primary" @click="formSubmit('approvedScaleUp', true)" v-show="stepsActive ===1">同意</el-button>
...
<script type="text/javascript" src="js/order/cmhas/approved/scaleUpStorage.js?t=<%=new Date().getTime() %>"></script>
</html>