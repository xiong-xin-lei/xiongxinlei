                      	...
                      	<el-row>
                            <el-col :span="6">
                                <el-form-item label="集群高可用" prop="proxysqlclusterHA">
                                    <el-switch v-model="formData.proxysqlclusterHA" @change="clusterHAChange"></el-switch>
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="集群高可用" prop="cmhaclusterHA">
                                    <el-switch v-model="formData.cmhaclusterHA" @change="clusterHAChange"></el-switch>
...
<script type="text/javascript" src="js/order/cfgs/CMHA.js?t=<%=new Date().getTime() %>"></script>
