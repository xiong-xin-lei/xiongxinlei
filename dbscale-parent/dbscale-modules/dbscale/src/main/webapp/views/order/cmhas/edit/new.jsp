                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="代理数量" prop="proxyNum">
                                <el-input-number v-model="formData.proxyNum" :step="1" :min="proxyMinNum"
                                    :max="proxyMaxNum" :disabled="!formData.proxyNum"></el-input-number>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
        ...
        <div style="position: absolute;right: 0px;bottom: 0px;width:778px">
            ...
            <div style="float: right;padding: 9px 20px">
                ...
                <el-button size="small" type="primary" @click="formSubmit('editNew', true)"
                    v-show="stepsActive===XEUtils.max([1, stepPageNum, stepPageNums])">保存
                </el-button>
...
<script type="text/javascript" src="js/order/cmhas/edit/new.js?t=<%=new Date().getTime() %>"></script>
