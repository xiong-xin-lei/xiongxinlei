        ...
        <vxe-table size="small" highlight-hover-row resizable auto-resize border="inner" style="color: #333333;"
            ...
            <vxe-table-column width="0" type="expand" :resizable="false">
                <template v-slot:content="{ row }">
                    <vxe-table size="small" style="color: #333333;margin: 10px 20px;border-left: 1px #E8EAEC solid" show-overflow show-header-overflow auto-resize border highlight-hover-row
                               row-id="id" :ref="'childTable'+row.index" :data="row.childRows"
                        ...
                        <vxe-table-column field="status" type="html" title="状态" width="13%">
                            <template v-slot="{ row }">
            ...
            <vxe-table-column sortable v-bind="commonMinWidth('状态')" type="html" show-header-overflow show-overflow width="150px">
                <template v-slot="{ row }">
...
<script type="text/javascript" src="js/order/task.js?t=<%=new Date().getTime() %>"></script>
