            ...
            <el-form ref="editNew" :model="formData" :rules="formRules" label-width="115px" size="small">
                ...
                <div v-else-if="stepsActive === 1" class="elSteps">
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <el-form-item label="副本数量" prop="unitCnt" v-if="formData.mode!=='single'">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="规模" prop="scale">
                                <el-select v-model="formData.scale" placeholder="请选择规模" style="display: block;"
                                    ref="scaleRadios" @change="scaleChange">
                                    <el-option :label="data.name" :value="data.name" v-for="data in scaleList"
                        ...
                        <el-col :span="12" v-if="getSession('storageMode') == 'volumepath'">
                            <el-form-item label="磁盘类型" prop="diskType">
                                <el-select v-model="formData.diskType" placeholder="请选择磁盘类型" style="display: block;">
                                    <el-option :label="data.name" :value="data.code" v-for="data in diskTypeList">
                                    </el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                    ...
                    <el-row>
                        <el-col :span="24">
                            <el-form-item label="表空间(G)" prop="dataSize">
                                <el-slider v-model="formData.dataSize" show-input :min=10 :max=500 :step=1
                    ...
                    <el-row>
                        ...
                        <el-col :span="4" v-if="advanced">
                            <el-checkbox v-model="paramDeploy" style="padding-top:5px" @change="paramDeployChange">参数配置
                            </el-checkbox>
                        </el-col>
                        <%--<el-col :span="4" v-if="advanced">
                            <el-checkbox v-model="backupPolicy" style="padding-top:5px" @change="backupPolicyChange">备份策略
                            </el-checkbox>
                        </el-col>--%>
                    </el-row>
                </div>
                    ...
                    <el-form-item label="参数配置" prop="hotSpare">
                        <vxe-table border show-footer height="300px" :data="paramData" ref="paramTable"
                            ...
                            <vxe-table-column title="配置参数" max-width="240px" align="center">
                                <template v-slot="{ row }">
                                    <el-select v-model="row.key" placeholder="请选择配置参数" size="small"
                                        ...
                                        ref="paramRadios" @change="paramChange(row)">
                            ...
                            <vxe-table-column title="当前值" max-width="240px" align="center">
                                <template v-slot="{ row }">
                                    <el-input v-model="row.value" placeholder="请输入内容" size="small"
                        ...
                        <el-col :span="8">
                            <el-form-item label="时间" prop="time" label-width="70px">
                                <el-time-picker v-model="formData.time" format="HH:mm" value-format="mm HH"
                                    placeholder="请选择时间" style="width: auto;" @change="verifyChange"></el-time-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
...
<script type="text/javascript" src="js/order/redis/edit/new.js?t=<%=new Date().getTime() %>"></script>
