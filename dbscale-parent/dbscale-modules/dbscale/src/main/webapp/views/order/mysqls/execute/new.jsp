...
<div id="executeNew" v-cloak>
                ...
                <%--<el-row>
                    <el-col :span="24">
                        <el-form-item label="日志空间(G)" prop="mysqllogSize">
                            <el-slider v-model="formData.mysqllogSize" show-input :min=10 :max=500 :step=1 disabled
                                       :format-tooltip="formatToolTip"></el-slider>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="备份周期" prop="cronExpression">
                            <el-select disabled v-model="formData.cronExpression" clearable style="display: block;">
    ...
    <div style="position: absolute;right: 0px;bottom: 0px;width:778px">
        ...
        <div style="float: right;padding: 10px 20px">
            ...
            <el-button size="small" type="primary" @click="formSubmit('executeNew')" v-show="stepsActive === XEUtils.max([1, stepPageNum, stepPageNums])">执行</el-button>
...
<script type="text/javascript" src="js/order/mysqls/execute/new.js?t=<%=new Date().getTime() %>"></script>
