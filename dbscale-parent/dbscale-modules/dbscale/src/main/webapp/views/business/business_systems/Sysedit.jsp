...
<%Object SysId = request.getAttribute("SysId");%>
var SysId = <%=SysId%>
</script>

<script type="text/javascript" src="js/business/business_systems/Sysedit.js?t=<%=new Date().getTime() %>"></script>
