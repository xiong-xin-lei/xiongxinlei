...
<div id="list" v-cloak>
    ...
    <div class="iframeBorder">
        ...
        <vxe-table size="small" highlight-hover-row resizable auto-resize border="inner" :max-height="table_heighth" style="color: #333333;"
            ...
            <vxe-table-column sortable field="type.display" v-bind="commonMinWidth('类型')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="name" v-bind="commonMinWidth('规模名称')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="cpuCnt" v-bind="commonMinWidth('CPU')" show-header-overflow show-overflow></vxe-table-column>
            <vxe-table-column sortable field="memSize" v-bind="commonMinWidth('内存(G)')" show-header-overflow show-overflow></vxe-table-column>
...
<script type="text/javascript" src="js/business/scales/list.js?t=<%=new Date().getTime() %>"></script>
