...
<body>
<div id="Subsedit" v-cloak>
	 <div style="padding:30px 40px 30px 20px">
	  	<el-form ref="editForm" :model="formData" label-width="120px" :rules="formRules" size="small">
...
<%Object SubsId = request.getAttribute("SubsId");%>
var SubsId = <%=SubsId%>
</script>

<script type="text/javascript" src="js/business/business_systems/Subsedit.js?t=<%=new Date().getTime() %>"></script>
