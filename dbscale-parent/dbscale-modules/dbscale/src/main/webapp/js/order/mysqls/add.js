...
var validateFileRetentionNum = (rule, value, callback) => {
    var timeType = ""
    switch (mysqlApp.formData.cronExpression) {
        case 'day':
            timeType = mysqlApp.formData.time !== null
            break;
        case 'week':
            timeType = mysqlApp.formData.time !== null && mysqlApp.formData.week !== null
            break;
        case 'month':
            timeType = mysqlApp.formData.time !== null && mysqlApp.formData.month !== null
            break;
    }
    var All = mysqlApp.formData.backupStorageType === '' && mysqlApp.formData.backUpType === '' &&
        mysqlApp.formData.cronExpression === '' && mysqlApp.formData.month === null &&
        mysqlApp.formData.week === null && mysqlApp.formData.time === null &&
        mysqlApp.formData.fileRetentionNum === undefined

    var FullAll = mysqlApp.formData.backupStorageType !== '' && mysqlApp.formData.backUpType !== '' &&
        mysqlApp.formData.cronExpression !== '' && mysqlApp.formData.fileRetentionNum !== undefined && timeType
