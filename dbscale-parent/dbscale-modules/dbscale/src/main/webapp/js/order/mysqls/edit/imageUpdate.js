...
new Vue({
    ...
    methods: {
        imageVersionListView: function (val) {
            ...
            sendGet("/" + getProjectName() + "/images?site_id=" + getSession("siteId") + "&type=" + _this.formData.orderType + "&enabled=true" + "&architecture=" + _this.formData.sysArchitectureCode + "&major=" + tempMajor + "&minor=" + tempMinor, function (response) {
                var json = []
