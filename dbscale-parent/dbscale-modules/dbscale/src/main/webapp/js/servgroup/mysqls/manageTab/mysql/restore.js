...
var mysqlRestoreApp = new Vue({
    ...
    methods: {
                    ...
                    if (getCheckboxTablerId) {
                        ...
                        commonConfirm(parent.manageApp, '还原确认', getRiskLevelHtml(4, riskText) + getHintText('还原'), setting).then(() => {
                            ...
                            _this.submitAjaxFun(submitData, function (data) {
                                ...
                                parent[0].mysqlListApp.refreshSaveData.push(parent[0].mysqlListApp.selectedData)
        ...
        formClose: function () {
            parent.layer.close(mysqlRestoreIndex);
        }
    }
})