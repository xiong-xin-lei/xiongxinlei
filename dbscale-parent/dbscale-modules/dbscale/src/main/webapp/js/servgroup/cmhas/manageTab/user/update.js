...
var userUpdataApp = new Vue({
    ...
    methods: {
        formDataCreatedFun: function () {
            var _this = this
            let url = "/" + getProjectName() + "/serv_groups/cmha/" + parent[0].rowId + "/users/" + username
        ...
        highAvailableAjaxFun: function () {
            let _this = this
            sendPut("/" + getProjectName() + "/serv_groups/cmha/" + parent[0].rowId + "/users/" + username, function (response) {
                let tempJson = {
        ...
        noHighAvailableAjaxFun: function (val, successFun, falseFun) {
            let _this = this
            sendPut("/" + getProjectName() + "/serv_groups/cmha/" + parent[0].rowId + "/users/" + username + "?ip=" + encodeURIComponent(val, "utf-8"), function (response) {
